...
- PvP may be enabled and disabled at-will. You will not be specifically indicated in any way if in PvP mode.
...
### Windows
Default Location: C:\Users\<Username>\Zomboid\mods

### Mac
Default Location: ~/Zomboid/mods/
